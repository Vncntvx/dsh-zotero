...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.7-rc.2"><img src="https://img.shields.io/badge/dsh-0.1.7--rc.2-blue" alt="dsh 版本" style="max-width:100%;"></a>
...
- **默认只读**：只有显式开启 `writeEnabled` 后，三个写工具才可创建研究笔记、加标签或加入个人库合集；每次写入都先展示计划卡等待批准（没有关掉它的开关），另加 Zotero 10 本地授权
...
- **文件**：只读，`zotero_attachment` 用异步 `stat` 校验 Zotero 返回的附件路径，不写文件系统
