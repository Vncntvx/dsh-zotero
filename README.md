...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.7-rc.1"><img src="https://img.shields.io/badge/dsh-0.1.7--rc.1-blue" alt="dsh 版本" style="max-width:100%;"></a>
...
- Node.js ≥ 22.19（或 ≥ 24）
- 宿主 dsh 0.1.7-rc.1（恰好该版本：`engines.dsh` 与全部 `@deepseek-ai/dsh-*` peer 均为 exact pin，不兼容其他 dsh 版本）
