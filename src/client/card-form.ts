/**
 * Shared staged-form model behind the Zotero settings card.
 *
 ...
 *
 * The form publishes through a snapshot source because slot components read
 * through a bound selector hook, while both the scope and the local drafts
...
export class CardForm {
   ...
   * @returns the form state the card chrome shares.
   */
  shell(): CardShell {
